...
mod tests {
    ...
    fn initiate_state() {
        ...
        let entry2 = Entry {id: 2, data: Bytes::from(&b"This is Naidu "[..]), expires_at: Some(Instant::now())};
    ...
    fn initiate_db() {
        let entry1 = Entry {id: 1, data: Bytes::from(&b"Hello World"[..]), expires_at: Some(Instant::now())};
        let entry2 = Entry {id: 2, data: Bytes::from(&b"This is Naidu "[..]), expires_at: Some(Instant::now())};
        let entry3 = Entry {id: 3, data: Bytes::from(&b"This is Naidu "[..]), expires_at: Some(Instant::now())};
        let entry4 = Entry {id: 4, data: Bytes::from(&b"This is Naidu "[..]), expires_at: Some(Instant::now())};
